...
########################################
our $trimmomatic_cmd = "java -jar /Programs/Trimmomatic-0-2.36/trimmomatic-0.36.jar";
our $trimmomatic_adapter = "/Programs/Trimmomatic-0-2.36/adapters/NexteraPE-PE.fa";
our $flash_cmd = "/Programs/FLASh/flash";
...
our $clustalo_cmd = "/Programs/clustalo/clustal-omega";
our $vcfconcatcmd = "vcf-concat"; ### part of vcftools
our $picard_path = "/Programs/picard-tools/";
