...
my $bwalog = "$outdir/bwalog.log";
my $trimlog = "$trimdir/trimlog.log";
open TRIM, ">$trimlog";
...
system ("${gatk_path}gatk HaplotypeCaller -R $grape_genome_db -O $outdir/merged.vcf -I $outdir/merged.clean.bam");
